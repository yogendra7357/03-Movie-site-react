        ...
        return (
            <>
                ...
                <div className=" overflow-hidden px-20 mb-20">
                    <h2 className="text-2xl font-bold text-center mx-20 my-10 shadow-sm shadow-cyan-300 py-1 bg-gray-800 text-white">High Rated Movies</h2>
                    <div className=" flex space-x-4 overflow-x-scroll movie-slider ">
                        {movies.length > 0 ? (
                            movies.map((movie) => (
                                    <a href=''>
                                <div key={movie.id} className=" bg-slate-950 rounded-lg h-[20rem] my-2  shadow-sm hover:shadow-sky-100 p-4 min-w-[200px]">
                                    <img
